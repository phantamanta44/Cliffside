package io.github.phantamanta44.cliffside.worldgen;
...
public class WorldGenSimple implements IWorldGenerator { 
	...
	public WorldGenSimple(BlockWithMeta blockToGen, int dimensionToGenerate, BlockWithMeta blockToReplace, int minY, int maxY, int perChunk, int veinDensity)
	{
		genBlock = blockToGen;
