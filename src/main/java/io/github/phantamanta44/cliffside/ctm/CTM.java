...
public class CTM {
	...
	protected CTM() {
		...
		submapMap.put(0, new Dir[] { Dir.BOTTOM, Dir.LEFT, Dir.BOTTOM_LEFT });
		submapMap.put(1, new Dir[] { Dir.BOTTOM, Dir.RIGHT, Dir.BOTTOM_RIGHT });
		submapMap.put(2, new Dir[] { Dir.TOP, Dir.RIGHT, Dir.TOP_RIGHT });
		submapMap.put(3, new Dir[] { Dir.TOP, Dir.LEFT, Dir.TOP_LEFT });
	}
