...
public class ContainerDisintegrator extends Container {
	...
	protected TileDisintegrator tile;
	
	public ContainerDisintegrator(InventoryPlayer ipl, TileDisintegrator te) {
		tile = te;
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotIndex) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (slotIndex == 1) {
				...
				if (DisintegratorRecipeHandler.recipeList.containsRecipeFor(stack)) {
	...
	public TileDisintegrator getTile() {
		return tile;
	}
